...
app.controller('orderExpressRecordController', function ($scope, Order, Util) {
    ...
    function fnGetList() {
        Util.loading();
        Order.getExpressRecord($scope.params).success(function (r) {
            Util.loading(false);
    ...
    // 获取快递人员列表
    Order.getExpressStaffHistory().success(function (r) {
