...
//                }
        ...
        callback: function (editor, $w, url, state) {
            ...
            if (state == "SUCCESS") {
                //显示图片计数+1
                Upload.showCount++;
                var $img = $("<img src='../../../../../scripts/lib/umeditor/dialogs/image/" + editor.options.imagePath + url + "' class='edui-image-pic' />"),
        ...
        initEvt: function () {
            ...
            $(".edui-image-searchAdd", me.dialog).on("click", function () {
                ...
                if (url) {
                    ...
                    $("<img src='../../../../../scripts/lib/umeditor/dialogs/image/" + url + "' class='edui-image-pic' />").on("load", function () {
