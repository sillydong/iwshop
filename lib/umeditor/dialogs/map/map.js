            ...
            ok: {
                exec: function (editor) {
                    ...
                    if (widget.root().find(".edui-map-dynamic")[0].checked) {
                        ...
                        editor.execCommand('inserthtml', '<iframe class="ueditor_baidumap" src="../../../../../scripts/lib/umeditor/dialogs/map/' + url + '" frameborder="0" width="' + (size.width+4) + '" height="' + (size.height+4) + '"></iframe>');
                    } else {
