...
<head>
    ...
    <title>我的客户 - {$settings.shopname}</title>
...
<body ng-controller="companyHomeController" ng-app="ngApp">
...
<script type="text/javascript" src="static/script/Wshop/shop_company_home.js?v={$cssversion}"></script>
